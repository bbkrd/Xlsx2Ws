...
public class TransformSettingWizard implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private TransformSettingVisual component;
    ...
    @Override
    public TransformSettingVisual getComponent() {
        if (component == null) {
            component = new TransformSettingVisual();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor wiz) {
        setting.setTransformSetting(component.createSetting());
