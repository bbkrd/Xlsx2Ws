...
public class X11SettingWizard implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private X11SettingVisual component;
    ...
    @Override
    public X11SettingVisual getComponent() {
        if (component == null) {
            component = new X11SettingVisual();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor wiz) {
        setting.setX11Setting(component.createSetting());
