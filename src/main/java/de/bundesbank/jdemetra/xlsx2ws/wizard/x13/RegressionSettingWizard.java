...
public class RegressionSettingWizard implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private RegressionSettingVisual component;
    ...
    @Override
    public RegressionSettingVisual getComponent() {
        if (component == null) {
            component = new RegressionSettingVisual();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor wiz) {
        setting.setRegressionSetting(component.createSetting());
    }
