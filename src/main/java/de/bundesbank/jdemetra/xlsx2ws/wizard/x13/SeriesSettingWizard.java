...
public class SeriesSettingWizard implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private SeriesSettingVisual component;
    ...
    @Override
    public SeriesSettingVisual getComponent() {
        if (component == null) {
            component = new SeriesSettingVisual();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor wiz) {
        setting.setSeriesSetting(component.createSetting());
    }
